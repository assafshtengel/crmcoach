...
[Rest of the original code, exactly as shown in the first file, but with the button text changed from "צפה בספרייה" to "לצפייה בכל המחקרים" in the mental library card section]

[Continue with the exact same code until the end of the file]
